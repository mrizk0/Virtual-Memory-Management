...
UCFLAGS=-mno-red-zone -mno-sse -mcmodel=large -O0 -ffreestanding -nostdlib -nostdinc -Iuser/include
...
root/%: user/bin/%.o user/lib/ulib.o user/lib/liballoc.o
	@echo "  ULD  $@" 
...
userclean:
	@rm -f $(USER_BINARIES) user/lib/*.o user/bin/*.o
